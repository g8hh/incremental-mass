...
const ACHIEVEMENTS = {
    ...
    13: {
        title: 'Higher Rank',
        desc() { return `达到第 2 层。奖励：双倍质量增益。` },
        can() { return player.tier.gte(2) },
    },
    14: {
        title: 'Upgrade Power',
        desc() { return `获得愤怒的力量。 奖励：三档增益。` },
        can() { return player.rage_powers.gte(1) },
    },
    15: {
        title: 'MASSPOW!',
        desc() { return `获得 x${format(1000)} 质量力量.` },
        can() { return FUNCS.getMassPower().gte(1000) },
    },
    21: {
        title: 'Heavy go brr',
        desc() { return `推 ${formatMass('1e6')}.` },
        can() { return player.mass.gte(1e6) },
    },
    22: {
        title: 'Ranker',
        desc() { return `达到 10 级。奖励：双倍质量增益。` },
    ...
    24: {
        title: 'RAGEPUSHER',
        desc() { return `获得 ${format(1000)} 愤怒力量. 奖励：解锁新的愤怒力量升级。` },
        can() { return player.rage_powers.gte(1000) },
    },
    25: {
        title: 'Antimatter?',
        desc() { return `获取反暗物质。 奖励：暗物质效应更强。` },
        can() { return player.black_hole.adm.gte(1) },
    },
    31: {
        title: 'Highest mountain',
        desc() { return `推 ${formatMass('1.619e20')}.` },
        can() { return player.mass.gte(1.619e20) },
    },
    32: {
        title: 'Rankerer',
        desc() { return `达到等级 15. 奖励：三倍的质量增益。` },
        can() { return player.rank.gte(15) },
    },
    33: {
        title: 'Tierer',
        desc() { return `达到第 5 层。奖励：双倍 研究点 增益。` },
    ...
    41: {
        title: 'UY Scuti',
        desc() { return `推 ${formatMass('1.989e34')}.` },
        can() { return player.mass.gte(1.989e34) },
    },
    42: {
        title: 'Rankest',
        desc() { return `达到 20 级。奖励：四倍质量增益。` },
        can() { return player.rank.gte(20) },
    },
    43: {
        title: 'Black Storage',
        desc() { return `获得 ${formatMass(1e6)} 黑洞中储存的质量。 奖励：双倍储存质量增益。` },
        can() { return player.black_hole.stored_mass.gte(1e6) },
    },
    44: {
        title: 'Twenty Black Holes',
        desc() { return `获得总共 20 个暗物质。 奖励：双倍 研究点 增益。` },

...
var cnItems = {
    ...
    'Pent 5: Pentogen upgrades 4 softcap are weaker.': '五阶 5：五阶 升级 4 软上限变弱。',
    'Perform to Enter Multiverse #': '执行以进入多元宇宙 #',
    '效果: Challenges Alpha-Delta are stronger.': '效果：挑战阿尔法-德塔更强。',
    '效果: Multiples mass gain.': '效果：倍增质量增益。',
    '效果: Multiples Mass Power gain.': '效果：倍增质量力量增益。',
    '效果: Multiples RP gain.': '效果：倍增愤怒力量增益。',
    '效果: Substracts rank requirements.': '效果：减去级别要求。',
    '': '',
    '': '',
    '': '',
    '': '',
    ...
    '': '',
    'Tetr': '三阶',
    'Tetr 15: Increase Pentogen upgrade Power based on Tetrs (+FFFFF2.220F366,000,369%).': '三阶 15：增加基于三阶的五阶升级能力（+ FFFFF2.220F366,000,369％）。',
    ...
    'While in any of this challenge, Pentogen upgrades 1 & 5 will no longer give effects.': '而在任何这个挑战中，五阶升级1和5将不再产生效果。',
    'buy mass upgrades': '购买质量升级',

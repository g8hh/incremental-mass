...
var cnItems = {
    ...
    'Multiverse': '多元宇宙',
    'Automators': '自动化',
    'Raises mass upgrade 2 effect by 2.18 (additive': '将质量升级 2 效果提高 2.18（附加',
    'Rank 6: Multiples mass upgrades 2-3 effects based on ranks (x2.18).': '等级 6：乘以质量升级 2-3 效果基于等级 (x2.18) 。',
    '': '',
    '': '',
    '': '',
    '': '',
    ...
    '': '',
    '': '',
    'Tetr 15: Increase Pentogen upgrade Power based on Tetrs (+FFFFF2.220F366,000,369%).': 'Tetr 15：增加基于Tetrs的五角形升级能力（+ FFFFF2.220F366,000,369％）。',
    'Tetr 10: Mass upgrade 4 are x1.1 stronger.': 'Tetr 10:质量升级4比以前强了1.1倍。',
    'Raises mass upgrade 2 effect by FFFFF2.220F366,000,369 (additive': '提升质量升级2的效果FFFFF2.220F366,000,369(附加',
    'Ex-Mass': '额外质量',
    ...
    'Raises mass upgrade 2 effect by 1.00 (additive': '提高质量升级2的效果1.00(附加',
    ...
    'pent': 'pent',
    'tetr': 'tetr',
    'T.he T.hird T.ier': 'T.he T.hird T.ier',
    'UY Scuti': 'UY Scuti',
    'Heavy go brr': 'Heavy go brr',
    '': '',
    '': '',
    '': '',
...
var cnPrefix = {
    ...
    "Pentogen Powers (PP), which has generated ": "五倍体(PP)，已经产生",
}

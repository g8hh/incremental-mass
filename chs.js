...
var cnItems = {
    ...
    'Tier 512: Raise PP gain by 1.25.': '第 512 层：将 PP 增益提高 1.25。',
    ...
    'Adds softcap of RP effect.': '添加 研究点 效果 的软上限。',
    'Black Hole Extractor': '黑洞提取器',
    'Dark Matters Milestone': '暗物质里程碑',
    'Gain 10% of RP gain per second. Unlock third stored mass upgrade.': '每秒获得 研究点 增益的 10%。 解锁第三次存储的质量升级。',
    'Gain free mass upgrade 1-2 based on total Dark Matters (+1.903e148 to level).': '获得基于总暗物质的免费质量升级 1-2（+1.903e148 等级）。',
    'Gain more RP based on unspent Anti-Dark Matters.': '基于未使用的反暗物质获得更多 研究点。',
    ...
    'Unlocks new Rage Powers upgrades. Keep RP upgrades on reset.': '解锁新的 愤怒力量 升级。 在重置时保持 研究点 升级。',
